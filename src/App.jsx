  ...
  return (
    <div className="h-screen flex flex-col font-body justify-center items-center bg-black">
      <div className="flex flex-col items-center 2xl:mt-1 w-[87%] 2xl:w-[31%]">
        ...
        <div
          className="border-[1px] w-[84%] lg:w-[28%] md:w-[43%] 2xl:w-full mb-14 2xl:mb-[4.88rem] cursor-pointer flex flex-row rounded-[5px] px-3 2xl:px-5 py-[.3rem] 22xl:py-1 2xl:py-[.5rem] text-light-green"
          autoComplete="off"
        >
          <input
            className="bg-transparent pt-[.1rem] w-full flex justify-center items-center focus:outline-none focus:ring-0 placeholder:text-white placeholder:text-sm 2xl:placeholder:text-base 2xl:mb-[.13rem] text-xs lg:text-sm 2xl:text-xl text-white"
            type="text"
            placeholder="Search"
            onChange={(e) => {
